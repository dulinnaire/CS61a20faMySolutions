...
def closer_city(lat, lon, city_a, city_b):
    ...
    """
    "*** YOUR CODE HERE ***"
    imaginary_city = make_city('imagine', lat=lat, lon=lon)
    return get_name(city_a) if distance(imaginary_city, city_a) < distance(imaginary_city, city_b) else get_name(city_b)
