    ...
    def vend(self):
        if self.stock == 0:
            ...
            if self.balance == 0:
                ...
                temp = self.balance
                self.balance = 0
                return f"Here is your {self.item} and ${temp} change."
...
def is_bst(t):
    ...
    return judge and all([is_bst(b) for b in t.branches])
...
def preorder(t):
    ...
    if t.is_leaf():
        ...
        return [t.label] + [l for b in t.branches for l in preorder(b)]
